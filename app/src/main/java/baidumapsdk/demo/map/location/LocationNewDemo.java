 ...
 */
public class LocationNewDemo extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        locationListenner.locationComplete(LocationManager.getInstance().getBDLocation());
    ...
    class LocationListenner implements LocationManager.OnLocationListenner {
        ...
        @Override
        public void locationComplete(BDLocation location) {
